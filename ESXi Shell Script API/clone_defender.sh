...
echo memsize = \"1024\" >> $clonedir/$clonevmname.vmx
...
echo ide1:0.fileName = \"\" >> $clonedir/$clonevmname.vmx
echo ide1:0.deviceType = \"cdrom-raw\" >> $clonedir/$clonevmname.vmx
...
echo guestOS = \"ubuntu-64\" >> $clonedir/$clonevmname.vmx
echo cleanShutdown = \"FALSE\" >> $clonedir/$clonevmname.vmx
echo replay.supported = \"FALSE\" >> $clonedir/$clonevmname.vmx
echo evcCompatibilityMode = \"FALSE\" >> $clonedir/$clonevmname.vmx
echo softPowerOff = \"FALSE\" >> $clonedir/$clonevmname.vmx
...
echo usb.pciSlotNumber = \"34\" >> $clonedir/$clonevmname.vmx
echo ehci.pciSlotNumber = \"35\" >> $clonedir/$clonevmname.vmx
echo config.readOnly = \"FALSE\" >> $clonedir/$clonevmname.vmx
echo usb:0.present = \"TRUE\" >> $clonedir/$clonevmname.vmx
echo usb:1.present = \"TRUE\" >> $clonedir/$clonevmname.vmx
echo usb:0.deviceType = \"hid\" >> $clonedir/$clonevmname.vmx
echo usb:0.port = \"0\" >> $clonedir/$clonevmname.vmx
echo usb:0.parent = \"-1\" >> $clonedir/$clonevmname.vmx
echo usb:1.speed = \"2\" >> $clonedir/$clonevmname.vmx
echo usb:1.deviceType = \"hub\" >> $clonedir/$clonevmname.vmx
echo usb:1.port = \"1\" >> $clonedir/$clonevmname.vmx
echo usb:1.parent = \"-1\" >> $clonedir/$clonevmname.vmx
