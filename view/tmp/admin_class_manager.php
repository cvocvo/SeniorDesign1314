	  ...
	  <div class="jumbotron row">
		<div class="col-md-12">
			...
			<ul id="classManagerList" class="list-unstyled">
				<li><?=$data['Class_Name'']?><span class="glyphicon glyphicon-remove"></span> Remove Class</a></li>
	  ...
	  <div class="jumbotron row padT20">
		<div class="col-md-12">
			...
			<form role="form">
				...
				<!--ned to link up this portion to database along with all the other "Create" buttons -->
			</form>
		</div>
      </div>
